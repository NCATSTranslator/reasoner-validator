...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "error.query_graph.predicate.unknown"
        ),
        (
            LATEST_BIOLINK_MODEL,
            ...
            "warning.query_graph.predicate.non_canonical"
        ),
        (
            LATEST_BIOLINK_MODEL,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "error.knowledge_graph.predicate.mixin"
        ),
        (
            LATEST_BIOLINK_MODEL,
            ...
            "error.knowledge_graph.predicate.abstract"
        ),
        (
            LATEST_BIOLINK_MODEL,
